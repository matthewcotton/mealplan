...
let SideNavBar = () => {
    ...
    return (
        <>
            ...
            <section style={showNav ? { display: "block" } : { display: "none" }} className="side-nav-bar">
                ...
                <img id="nav-logo" src={LogoWhite} alt="recipe planner logo" />
                ...
                <button onClick={() => logOutFunction()} className="button-main button-side-nav">Logout</button>
            </section>
        </>
    )
}
